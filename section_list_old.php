            ...
            <div class="row">
                <div class="col-12">
                    <div class="text-center ">
                        <h1 class="text-primary">Our Section</h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="container-xl px-4">
        <div class="row">
            ...
            <?php
                ...
                $all = getAllSectionsWithBookTotals();
            ...
            <div class="col-lg-4 mb-4">
                ...
                <a class="card card-progress lift lift-sm border-start-lg border-start-secondary"
                    href="section.php?id=<?php echo $row['id'] ?>">
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        ...
                        <!-- <div class="small text-muted"><?php echo $book_name; ?> Book Name</div> -->
