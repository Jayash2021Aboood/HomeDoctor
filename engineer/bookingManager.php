<?php
  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') 
  {
    ...
    // =======================================================================
    // ======================== Engineer Adding Booking Note =================
    // =======================================================================

    if(isset($_POST['engineerAddBookingNote']))
    {
      $booking_id = $_POST['booking_id'];
      $note = $_POST['note'];
      $engineer_id = $customer_id = "";
      ...
      if(count($errors) == 0)
      {
        $add = addBookingNote($booking_id, $engineer_id, "NULL", $note);
        if($add ==  true)
        {
          $_SESSION["message"] = "Note Updated successfuly!";
          $_SESSION["success"] = "Note Updated successfuly!";
    ...
    // =======================================================================
    // ======================== Engineer Accept Booking  =====================
    // =======================================================================

    if(isset($_POST['engineerAcceptBooking']))
    {
      $booking_id = $_POST['booking_id'];  
      $customer_id = "";
    ...
    // =======================================================================
    // ======================== Engineer Reject Booking  =====================
    // =======================================================================

    if(isset($_POST['engineerRejectBooking']))
    {
      $booking_id = $_POST['booking_id'];  
      $engineer_id = "";
      ...
      if(count($errors) == 0)
      {
        ...
        $add = query("UPDATE booking SET state = 'reject' WHERE id = $booking_id");
        if($add ==  true)
        {
          $_SESSION["message"] = "Booking Updated successfuly!";
          $_SESSION["success"] = "Booking Updated successfuly!";
    ...
    // =======================================================================
    // ======================== Engineer Complete Service  =====================
    // =======================================================================

    if(isset($_POST['engineerCompleteService']))
    {
      $booking_id = $_POST['booking_id'];  
      $engineer_id = "";
      ...
      if(count($errors) == 0)
      {
        ...
        $add = query("UPDATE booking SET state = 'ready' WHERE id = $booking_id");
        if($add ==  true)
        {
          $_SESSION["message"] = "Booking Updated successfuly!";
          $_SESSION["success"] = "Booking Updated successfuly!";
    ...
    // =======================================================================
    // ======================== Enginner Change Booking Price ================
    // =======================================================================

    if(isset($_POST['engineerChangeBookingPrice']))
    {
      ...
      if($row['state'] == 'done' || $row['state'] == 'paid') 
        redirectToReferer("You cant update price for done or paid service!");
      ...
      if(count($errors) == 0)
      {
        ...
        $add = updateBooking($id, $engineer_id, $service_id, $customer_id, $card_number, $service_price, $paid_price, $detail, $booking_date, 'working');
        if($add ==  true)
        {
          $_SESSION["message"] = "Booking Updated successfuly!";
          $_SESSION["success"] = "Booking Updated successfuly!";
