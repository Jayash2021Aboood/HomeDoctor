    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                <!-- Nurse details card-->
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Nurse Details"); ?> <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="deleteNurse" class="btn btn-danger" type="submit"><?php echo lang("Delete"); ?></button>
