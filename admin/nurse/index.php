...
<main>
                        ...
                        <!-- <tr> 
                                            ...
                                            <td>
                                                <button class="btn btn-datatable btn-icon btn-transparent-dark me-2"
                                                    ...
                                                    data-bs-target="#editNurseModal"><i
    ...
    <!-- Create Nurse modal-->
    <div class="modal fade" id="createNurseModal" tabindex="-1" role="dialog" aria-labelledby="createNurseModalLabel"
        aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="createNurseModalLabel">Create New Nurse</h5>
                    <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formNurseName">Nurse
                                Name</label>
                            <input class="form-control" id="formNurseName" type="text"
                    ...
                    <form>
                        <div class="mb-0">
                            <label class="mb-1 small text-muted" for="formNurseName">Nurse
                                Name</label>
                            <input class="form-control" id="formNurseName" type="text"
                                placeholder="Enter Nurse name..." value="Sales" />
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
