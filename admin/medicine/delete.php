<?php
  ...
  $pageTitle = lang("Delete Medicine");
    ...
    if(isset($_POST['deleteMedicine']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["message"] = lang("Medicine Deleted successfuly!");          
          $_SESSION["success"] = lang("Medicine Deleted successfuly!");          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Medicine Details"); ?> <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="deleteMedicine" class="btn btn-danger" type="submit"><?php echo lang("Delete"); ?></button>
