    ...
    if(isset($_POST['updatePatient']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($update ==  true)
        {
          ...
          $_SESSION["message"] = lang("Patient Updated successfuly!");
          $_SESSION["success"] = lang("Patient Updated successfuly!");
          header('Location:'. $PATH_ADMIN_PATIENT .'index.php');
          exit();
        }
        else
        {
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="updatePatient" class="btn btn-success" type="submit"><?php echo lang("Save"); ?></button>
