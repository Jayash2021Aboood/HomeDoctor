  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') 
  {
    if(isset($_POST['addPatient']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($add ==  true)
        {
          $_SESSION["message"] = lang("Patient Added successfuly!");
          $_SESSION["success"] = lang("Patient Added successfuly!");
                ...
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="addPatient" class="btn btn-success" type="submit"><?php echo lang("Save"); ?></button>
