<?php
  ...
  $pageTitle = lang("Delete Appointment");
                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            <?php echo lang("Delete Appointment"); ?>
                        </h1>
                    </div>
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Appointment Details"); ?> <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="deleteAppointment" class="btn btn-danger" type="submit"><?php echo lang("Delete"); ?></button>
