<?php
  ...
  $pageTitle = "Delete BookingAttachment";
    ...
    if(isset($_POST['deleteBookingAttachment']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["message"] = "BookingAttachment Deleted successfuly!";          
          $_SESSION["success"] = "BookingAttachment Deleted successfuly!";          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">BookingAttachment Details <span
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="attachment" name="attachment" type="text" placeholder="Attachment"
                                        value="<?php echo $row['attachment'];?>" readonly />
                                </div>
 
                            </div>
                            <!-- Submit button-->
                            <button name="deleteBookingAttachment" class="btn btn-danger" type="submit">Delete</button>
