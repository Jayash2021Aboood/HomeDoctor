  ...
  if ($_SERVER['REQUEST_METHOD'] === 'POST') 
  {
    if(isset($_POST['addDoctor']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($add ==  true)
        {
          $_SESSION["message"] = lang("Doctor Added successfuly!");
          $_SESSION["success"] = lang("Doctor Added successfuly!");
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                <!-- Doctor details card-->
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Doctor Details"); ?></div>
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="addDoctor" class="btn btn-success" type="submit"><?php echo lang("Save"); ?></button>
