    ...
    if(isset($_POST['deleteDoctor']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["message"] = lang("Doctor Deleted successfuly!");          
          $_SESSION["success"] = lang("Doctor Deleted successfuly!");          
          header('Location:'. $PATH_ADMIN_DOCTOR .'index.php');
          exit();
        }
        else
        {
                ...
                <div class="row align-items-center justify-content-between pt-3">
                    <div class="col-auto mb-3">
                        <h1 class="page-header-title">
                            ...
                            <?php echo lang("Delete Doctor"); ?>
                        </h1>
                    </div>
                    <div class="col-12 col-xl-auto mb-3">
                        <a class="btn btn-sm btn-light text-primary" href="index.php">
                            <i class="me-1" data-feather="arrow-left"></i>
                            <?php echo lang("Back to Doctors List"); ?>
                        </a>
                    </div>
                </div>
            </div>
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                <!-- Doctor details card-->
                <div class="card mb-4">
                    <div class="card-header"><?php echo lang("Doctor Details"); ?> <span
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="date_of_graduate" name="date_of_graduate" type="text" placeholder="<?php echo lang("Date of Graduate"); ?>"
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="cv" name="cv" type="text" placeholder="<?php echo lang("CV"); ?>"
                            ...
                            <!-- Submit button-->
                            <button name="deleteDoctor" class="btn btn-danger" type="submit"><?php echo lang("Delete"); ?></button>
