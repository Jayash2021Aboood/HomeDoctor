    ...
    if(isset($_POST['deleteEngineer']))
    {
      if(isset($_GET['id']))
      {
        ...
        if($delete ==  true)
        {
          ...
          $_SESSION["message"] = "Engineer Deleted successfuly!";          
          $_SESSION["success"] = "Engineer Deleted successfuly!";          
    ...
    <div class="container-xl px-4 mt-4">
        <div class="row">
            <div class="col-xl-12">
                ...
                <div class="card mb-4">
                    <div class="card-header">Engineer Details <span
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <!-- Submit button-->
                            <button name="deleteEngineer" class="btn btn-danger" type="submit">Delete</button>
