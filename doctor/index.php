                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <div class="h5">R.S
                                <?php echo (select("select sum(price) as total from appointment WHERE doctor_id =$doctor_id and state ='accept';")[0])['total']; ?>
                                </div>
                        ...
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <div class="h5 text-center">
                                    <?php echo (select("select count(id) as total from appointment where doctor_id=$doctor_id ;")[0])['total']; ?>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <div class="h5 text-center">
                                    <?php echo (select("select count(id) as total from appointment where doctor_id=$doctor_id and state like 'request' ;")[0])['total']; ?>
                                </div>
                                <!-- <div class="text-xs fw-bold text-danger d-inline-flex align-items-center">
                                    <i class="me-1" data-feather="trending-down"></i>
                                    3%
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <div class="h5 text-center">
                                    <?php echo (select("select count(id) as total from appointment where doctor_id=$doctor_id and state like 'reject' ;")[0])['total']; ?>
                                </div>
                                <!-- <div class="text-xs fw-bold text-danger d-inline-flex align-items-center">
                                    <i class="me-1" data-feather="trending-down"></i>
                                    3%
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <div class="h5 text-center">
                                    <?php echo (select("select count(id) as total from appointment where doctor_id=$doctor_id and state like 'accept' ;")[0])['total']; ?>
                                </div>
                                <!-- <div class="text-xs fw-bold text-danger d-inline-flex align-items-center">
                                    <i class="me-1" data-feather="trending-down"></i>
                                    3%
