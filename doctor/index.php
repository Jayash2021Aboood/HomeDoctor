            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card border-start-lg border-start-success h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="fw-bold text-success mb-3 text-center"><?php echo lang("Patients"); ?> (count)</div>
                                <div class="h5 text-center">
                                    <?php echo (select("select count(id) as total from patient;")[0])['total']; ?>
                                </div>
                                <!-- <div class="text-xs fw-bold text-danger d-inline-flex align-items-center">
                                    <i class="me-1" data-feather="trending-down"></i>
                                    3%
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                ...
                                <div class="h5 text-center">
                                    <?php echo (select("select count(id) as total from appointment;")[0])['total']; ?>
                                </div>
                                <!-- <div class="text-xs fw-bold text-danger d-inline-flex align-items-center">
                                    <i class="me-1" data-feather="trending-down"></i>
                                    3%
