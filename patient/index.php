...
<main>
    ...
    <div class="container-xl px-4 mt-5">
        ...
        <?php $patient_id = $_SESSION['userID']; ?>
        <div class="row">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="small fw-bold text-primary mb-1"><?php echo lang("Paid Money"); ?></div>
                                <div class="h5">R.S
                                    <?php echo (select("select sum(price) as total from appointment WHERE patient_id =$patient_id and state ='accept';")[0])['total']; ?>
                                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card border-start-lg border-start-orange h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="fw-bold text-orange mb-3 text-center"><?php echo lang("My Appointments"); ?>  (count)</div>
                                <div class="h5 text-center">
                                <?php echo (select("select count(id) as total from appointment WHERE patient_id =$patient_id;")[0])['total']; ?>
                                </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card border-start-lg border-start-pink h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="fw-bold text-pink mb-3 text-center"><?php echo lang("Booked Doctors"); ?> (count)</div>
                                <div class="h5 text-center">
                                    <?php echo (select("select count(doctor_id) as total from appointment WHERE patient_id =$patient_id;")[0])['total']; ?>
                                </div>
                                <!-- <div class="text-xs fw-bold text-danger d-inline-flex align-items-center">
                                    <i class="me-1" data-feather="trending-down"></i>
                                    3%
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                ...
                <div class="card border-start-lg border-start-secondary h-100">
                    <div class="card-body">
                        <div class="d-flex align-items-center">
                            <div class="flex-grow-1">
                                <div class="fw-bold text-secondary mb-3 text-center"><?php echo lang("Booked Nurses"); ?> (count)</div>
                                <div class="h5 text-center">
                                <?php echo (select("select count(nurse_id) as total from appointment WHERE patient_id =$patient_id;")[0])['total']; ?>
                                </div>
                                <!-- <div class="text-xs fw-bold text-danger d-inline-flex align-items-center">
                                    <i class="me-1" data-feather="trending-down"></i>
                                    3%
