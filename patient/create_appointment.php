<?php
  ...
  if( count($setting) > 0 ){
    ...
    redirectToReferer(lang("You shloud to do setting for website fisrt"));
  }
    ...
    if(isset($_POST['addAppointment']))
    {
      ...
      if(count($errors) == 0)
      {
        ...
        if($add ==  true)
        {
          ...
          header('Location:'. $PATH_PATIENT .'index.php');
          exit();
        }
        else
        {
                            ...
                            <div class="row gx-3 mb-3">
                                ...
                                <div class="col-md-4 mb-3 d-none">
                                    ...
                                    <select class="form-select" name="patient_id" id="patient_id" required>
                                        ...
                                        <option <?php if($_SESSION['userID'] == $Patient['id']) echo "selected" ?> value="<?php echo $Patient['id']; ?>"> <?php echo $Patient['first_name']; ?>
                                        </option>
                                        <?php }?>
                                    </select>
                                </div>
                                ...
                                <div class="col-md-4 mb-3">
                                    ...
                                    <input class="form-control" id="price" name="price" type="text" placeholder="<?php echo lang("Price"); ?>"
                                        value="<?php echo $setting['appointment_price']; ?>" required  readonly />
                                </div>
                                <!-- Form Group (state)-->
                                <div class="col-md-4 mb-3 d-none">
