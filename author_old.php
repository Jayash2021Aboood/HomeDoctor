...
<?php
  if ($_SERVER['REQUEST_METHOD'] === 'GET') 
  {
    ...
    //   جلب بيانات المهندس اعتمادا على المعرف وعرضها في الصفحة
      $result = getAllAuthorWithBookTotals($id);
        ...
        <div class="container-xl px-4">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12 mt-4 text-center">
                    ...
                    <p class="mb-0 mt-0 "> Phone number : <?php echo $row['phone']; ?></p>
                    <p class="mb-0 mt-0 "> Email:<?php echo $row['email']; ?></p>
                    <p class="mb-0 mt-0 "> From: <?php echo $row['nationality']; ?></p>
                    <p class="mb-0 mt-0 ">Adderss: <?php echo $row['address']; ?>
                    </p>
                </div>
                <!-- <div class="col-md-6 col-sm-12 mt-4 text-center">
